  ...
  return(
    <main className='min-h-screen flex items-start justify-center pt-12 bg-amber-100'>
      <div className='bg-zinc-50 p-8 rounded-lg shadow-md max-w-md w-full'>
        ...
        <p className='text-blue-500 hover:text-blue-700'><Link href="/week-6">Week 6 Assignment</Link></p>
        <p className='text-blue-500 hover:text-blue-700'><Link href="/week-7">Week 7 Assignment</Link></p>
        <p className='text-blue-500 hover:text-blue-700'><Link href="/week-8">Week 8 Assignment</Link></p>
        <p className='text-blue-500 hover:text-blue-700'><Link href="/week-10">Week 10 Assignment</Link></p>
        </div>
      </div>
    </main>
  );
